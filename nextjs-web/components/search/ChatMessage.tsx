...
export function ChatMessage({ message }: ChatMessageProps) {
  ...
  return (
    <div className={cn(
      "group flex gap-3 mb-6 animate-in fade-in-50 slide-in-from-bottom-2",
      ...
      <div className={cn(
        ...
        <div className={cn(
          "inline-block max-w-[85%] rounded-2xl px-4 py-3 relative",
          isUser 
              ...
              {message.content ? (
                <ReactMarkdown
                  ...
                  components={{
                    ...
                    blockquote: ({ children }) => (
                      <blockquote className="border-l-2 border-muted-foreground/20 pl-2 italic text-sm">
                        {children}
                      </blockquote>
                    ),
                    table: ({ children }) => (
                    ...
                    th: ({ children }) => (
                      <th className="border border-border px-1 py-0.5 bg-muted font-semibold text-left">
                        {children}
                      </th>
                    ),
                    td: ({ children }) => (
